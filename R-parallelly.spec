...
Version  : 1.44.0
Release  : 52
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/parallelly_1.44.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/parallelly_1.44.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746715859
...
/usr/lib64/R/library/parallelly/test-data/mixed-cgroups/piavpn-cgroups.tar.gz
/usr/lib64/R/library/parallelly/test-data/mixed-cgroups/piavpn.R
/usr/lib64/R/library/parallelly/test-data/mixed-cgroups/slurm-cgroups.tar.gz
