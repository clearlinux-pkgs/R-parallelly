...
Version  : 1.26.1
Release  : 12
URL      : https://cran.r-project.org/src/contrib/parallelly_1.26.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/parallelly_1.26.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625065989
