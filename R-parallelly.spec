...
Version  : 1.27.0
Release  : 14
URL      : https://cran.r-project.org/src/contrib/parallelly_1.27.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/parallelly_1.27.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626796514
